...
predict_1 <- arima.sim(list(ar=0,ma=fit$arima_1["ma1"]),sd=sqrt(arima_1$sigma2),200)
plot(predict_1)

predict_2 <- arima.sim(list(ar=0,ma=fit$arima_2["ma1"]),sd=sqrt(arima_2$sigma2),200)
plot(predict_2)

predict_3 <- arima.sim(list(ar=0,ma=fit$arima_3["ma1"]),sd=sqrt(arima_3$sigma2),200)
plot(predict_3)
```
